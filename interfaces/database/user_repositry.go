...
func (repo *UserRepositry) Store(u domain.User) (id int, err error) {
...
func (repo *UserRepositry) FindById(identifier int) (user domain.User, err error) {
...
func (repo *UserRepositry) FindAll() (users domain.Users, err error) {
